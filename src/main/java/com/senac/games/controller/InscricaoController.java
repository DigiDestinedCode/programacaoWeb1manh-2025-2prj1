...
public class InscricaoController {
    ...
    @Operation(
            ...
            description = "Endpoint para inscricaos por Id de inscricao")

    public ResponseEntity<Inscricao> listarPorInscricaoId(@PathVariable("inscricaoId") Integer inscricaoId){
        Inscricao inscricao = inscricaoService.listarPorInscricaoId(inscricaoId);
        if(inscricao == null) {
    ...
    @Operation(summary = "Apagar registro do inscricao", description = "Endpoint para apagar registro do inscricao")

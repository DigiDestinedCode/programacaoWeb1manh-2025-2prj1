...
public class CategoriaController {
    ...
    @Operation(
            ...
            description = "Endpoint para listar categoria por Id de categoria"
    )
    public ResponseEntity<CategoriaDTOResponse> listarPorCategoriaId(@PathVariable("categoriaId") Integer categoriaId) {
    ...
    @Operation(
            summary = "Atualizar campo status do categoria",
            description = "Endpoint para atualizar apenas o status do categoria"
    )
    public ResponseEntity<CategoriaDTOUpdateResponse> atualizarStatusCategoria(
            @PathVariable("categoriaId") Integer categoriaId,
            @Valid @RequestBody CategoriaDTORequest categoriaDTOUpdateRequest
    ) {
    ...
    @Operation(
            summary = "Apagar registro do categoria",
            description = "Endpoint para apagar registro do categoria"
    )
    public ResponseEntity<Void> apagarCategoria(@PathVariable("categoriaId") Integer categoriaId) {
